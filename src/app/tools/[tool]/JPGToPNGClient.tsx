...
export default function JPGToPNG({ tool }: { tool?: string }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/tools/jpg-to-png", {
        method: "POST",
        body: formData,
      });
      ...
      link.href = url;
      link.download = (outputName || "converted") + ".png";
    ...
    <section className="relative bg-gray-900 text-yellow-400 overflow-hidden min-h-screen flex flex-col items-center justify-center px-4">
      <div className="relative z-10 max-w-3xl w-full text-center">
        ...
        <p className="text-lg md:text-xl mb-8 text-gray-300">
          Convert your JPG images to PNG format instantly and easily. Upload
          your image and get the result in seconds!
        </p>
